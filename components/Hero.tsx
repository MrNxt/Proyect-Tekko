  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-2xl z-10 mb-8 mx-auto">
        ...
        >
          Tekko es una app diseñada para ayudar a niños con autismo,
          fortaleciendo el vínculo entre padres e hijos mediante actividades
        ...
        >
          <a
            href="https://forms.gle/N8sYmJn2vWXzhM6Q8"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block px-6 py-3 rounded-full bg-yellow-400 hover:bg-yellow-500 text-black font-bold text-lg sm:text-xl shadow-lg hover:shadow-yellow-500/50 transition-all duration-300"
          >
      ...
      <div
        ref={charactersRef}
        className="relative w-full max-w-6xl h-[500px] mb-12"
      >
        {/* Personaje principal */}
      ...
      <div className="mt-8 text-center z-20 max-w-xl">
        <p className="text-sm text-gray-300">
          Tekko actúa como un puente entre padres e hijos. Permite a los adultos
          acompañar de cerca el progreso de sus hijos
        </p>
      </div>
    </section>
  );
